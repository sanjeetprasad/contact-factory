...
contactFactory should return an object with three properties: name,
 title, email.
Make contactFactory take a single argument, which will be treated as an array.
In the body of the function, loop over that array to set the values of the object's 
properties.
Create a second function called createContact
createContact should take three arguments: name, title, email.
Have the function place the three arguments into an array and pass that array to the 
contactFactory by calling it.
...
function contactFactory(contactData) {
  ...
  createContact("Sanjeet", "Manager", "sanjeet@gmail.com");